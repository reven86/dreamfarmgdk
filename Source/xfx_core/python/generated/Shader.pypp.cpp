...
void register_Shader_class(){
    ...
    { //::xfx::Shader
        ...
        { //::xfx::Shader::SetTextureToStage
        
            typedef ::HRESULT ( ::xfx::Shader::*set_texture_to_stage_function_type )( int const &,::boost::shared_ptr< xfx::ITexture const > const & ) ;
            
            Shader_exposer.def( 
                "set_texture_to_stage"
                , set_texture_to_stage_function_type( &::xfx::Shader::SetTextureToStage )
                , ( bp::arg("stage"), bp::arg("texture") ) );
